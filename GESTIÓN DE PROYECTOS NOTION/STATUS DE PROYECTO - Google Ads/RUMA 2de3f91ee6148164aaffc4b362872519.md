...
Proyecto: Google Ads (https://www.notion.so/Google-Ads-2d13f91ee61480d19103c01f5406fcea?pvs=21)
...
Problema/Objetivo: Subimos presupuestos y actualizamos los anuncios de PMax
TESTING: Yes
...
- [x]  Anuncio(s) ganadores identificados.
- [x]  Resultados constantes por 2 semanas.

Tareas Específicas.

- [x]  Optimización semanal de presupuesto y anuncios.
- [x]  Medición y estandarización del CPA.
